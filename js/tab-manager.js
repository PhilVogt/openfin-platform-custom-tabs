...
function setupTabs(data, tabOptions) {
	if (data !== undefined && data.views !== undefined) {
...
function setupComponent(name, viewName) {
	console.log(
		"tab-manager: setupComponent called for view: " + viewName + " to add component: " + name
	);
